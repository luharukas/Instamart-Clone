...
<html lang="en">
	<head>
	    ...
	    <title>INSTAMART shopping portal Home Page</title>
    ...
    <body class="cnt-home" style="background:linear-gradient(to top right, #66ffff 21%, #00ff99 109%);">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		...
		<img src="https://wallpapercave.com/wp/wp9217937.jpg" width=850px height=370px >
				<!-- /.container-fluid -->
</img><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<img src="https://www.incimages.com/uploaded_files/image/1920x1080/getty_518504426_2000196920009280941_319976.jpg"width=850px height=370px>
			</img><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Free shipping on all orders</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Fruits & veggies</a></li>
					<li><a href="#furniture" data-toggle="tab">Rice,dals & Masalas</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Dairy & Bread</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Rice, dals and Masalas</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=5");
while ($row=mysqli_fetch_array($ret)) 
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Fruits & veggies</h3>
