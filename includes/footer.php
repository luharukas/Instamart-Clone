...
<h3>INSTAMART CLONE</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> We deliver when you need, from your neighbourhood grocery store.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="https://www.swiggy.com/swiggy-instamart.">www.swiggy.com/instamart</a></span>
                </div>
            </li>
